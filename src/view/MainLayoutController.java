...
public class MainLayoutController {
    ...
    private void initialize() {
    	...
    	Z21Wrapper.instance.getCurrentStatus().addListener(new ChangeListener<Z21Wrapper.STATUS>() {
			...
			@Override
			public void changed(ObservableValue<? extends wrapper.Z21Wrapper.STATUS> observable, wrapper.Z21Wrapper.STATUS oldValue, wrapper.Z21Wrapper.STATUS newValue) {
				Color newcolor;
				String text;
				switch (newValue) {
					case CONNECTED:
    ...
    private void connectPressed(ActionEvent event)  {
    	...
    	Z21Wrapper.instance.requestCV(8, 1,new Z21Callback() {
			...
			public void run() {
				if (getUserdata() == null) {
					Platform.runLater(() -> { 
//						vendorLabelString.set(I18n.getMsg("Keine Lok gefunden (NACK)"));
